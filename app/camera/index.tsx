...
export default function CameraScreen() {
  ...
  const onRequestPermision = async () => {
    try {
      ...
      if (mediaPermissionStatus !== "granted") {
        Alert.alert(
          "Lo siento",
          "Necesitamos permiso a la galeria para seleccionar las fotos"
        );
        return;
      }
    } catch (error) {
  ...
  if (!cameraPermission.granted) {
    ...
    return (
      ...
      >
        ...
        <TouchableOpacity onPress={onRequestPermision}>
  ...
  const onPickImages = async () => {
    ...
    result.assets.map((a) => addSelectedImage(a.uri));
    router.dismiss();
  };
  ...
  if (selectedImage) {
    return (
      <View style={styles.container}>
        ...
        <RetakeImageButton onPress={onPictureRetake} />
      </View>
    );
  }
